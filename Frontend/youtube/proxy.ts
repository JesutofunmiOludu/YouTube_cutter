...
// middleware.ts  (must be at the project root, alongside package.json)
//
...
// The cookie is set by the auth store after login.
// ============================================================
...
const PROTECTED_PREFIXES = [
  ...
  '/research',
  '/settings',
  // NOTE: /pricing is intentionally NOT protected — it's a public marketing page
]
...
function proxy(request: NextRequest) {
  ...
  // Read JWT token from cookie (set after login by auth.store.ts)
